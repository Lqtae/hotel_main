...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (strlen($new_password) < 6) {
        $_SESSION['errors'] = ["รหัสผ่านต้องมีความยาวอย่างน้อย 6 ตัว"];
    } else {
        ...
        if ($stmt->execute([$hashed_password, $user_id])) {
            ...
            $_SESSION['errors'] = ["ไม่สามารถเปลี่ยนรหัสผ่านได้"];
        }
    }
}
?>
        ...
        <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-lg">
            ...
            <form action="reset_password.php" method="POST">
                <div class="relative mb-4">
                    <input type="password" id="new_password" name="new_password" class="peer h-10 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-black" placeholder="New Password">
