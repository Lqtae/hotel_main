        ...
        <h1 class="text-3xl block text-center font-semibold"><i class="fa-regular fa-registered"></i> Register</h1>
            <form action="register_db.php" method="post">
                <div class="relative mt-8">
                    <input id="username" type="text" name="username" class="peer h-10 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-black" placeholder="Username"/>
                ...
                <div class="relative mt-8">
                    <input id="email" type="text" name="email" class="peer h-10 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-black" placeholder="Email"/>
                ...
                <div class="relative mt-8">
                    <input id="password_1" type="password" name="password_1" class="peer h-10 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-black" placeholder="Password"/>
                ...
                <div class="relative mt-8">
                    <input id="password_2" type="password" name="password_2" class="peer h-10 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-black" placeholder="Confirm password"/>
